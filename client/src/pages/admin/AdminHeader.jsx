...
import ChatPopDown from "../../components/common/ChatPopDown";
  ...
  return (
    <>
      <header className="w-full bg-pink-800 text-white p-3 flex items-center justify-between shadow-md relative">
        ...
        {openChatDropDown && (
          <div
            className={`absolute w-[200px] bg-white shadow-lg border border-gray-300 z-10 px-1 pt-1 right-32 top-12 rounded`}
          >
            <ChatPopDown
        ...
        {messagePopUp && (
          <div
            className={`absolute w-[300px] bg-white shadow-lg border-gray-300 z-10 px-2 py-1 right-5 md:top-[380px]`}
          >
            <ChatPopUp
              messagePopUp={messagePopUp}
              setMessagePopUp={setMessagePopUp}
